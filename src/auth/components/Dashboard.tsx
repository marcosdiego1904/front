            ...
            <div className="px-4 py-8 sm:px-0">
              <div className="border-4 border-dashed border-gray-200 rounded-lg h-96 flex items-center justify-center">
                <div className="text-center">
                  <h2 className="text-xl text-gray-500">Welcome to your dashboard, {user?.username}!</h2>
                  <p className="mt-2 text-gray-500">This is where your main application content will go.</p>
                </div>
              </div>
            </div>
          </div>
