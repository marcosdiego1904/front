 ...
 *
 * Provides a simpler API for updating page SEO without needing a component
 *
 * @example
 * ```tsx
 * function MyPage() {
...
export function useSEO({
  ...
  useEffect(() => {
    ...
    if (structuredData) {
      let script = document.querySelector('script[data-page-structured-data]');
      if (!script) {
...
/**
 * Pre-configured SEO options for common pages
 */
