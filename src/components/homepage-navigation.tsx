      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0 cursor-pointer" onClick={handleLogoClick}>
            <h1 className="font-serif text-xl font-semibold text-gray-900 tracking-tight">
              Lamp to My Feet
            </h1>
          </div>
            ...
            {!isAuthenticated ? (
              <>
                ...
                <button
                  ...
                  className="relative px-6 py-2.5 bg-gradient-to-r from-gray-900 to-gray-800 text-white text-sm font-semibold rounded-lg shadow-lg hover:shadow-xl hover:from-gray-800 hover:to-gray-700 transform hover:scale-[1.02] transition-all duration-200 overflow-hidden group"
                >
          ...
          <div className="pt-3 border-t border-gray-200/50 mt-3">
            {!isAuthenticated ? (
              <>
                <button
                  onClick={handleLoginClick}
                  className="block w-full text-left px-4 py-3 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100/60 rounded-lg transition-all duration-200"
                >
                  Log In
                </button>
