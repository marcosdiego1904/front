        ...
        <div className="row justify-content-center">
          <div className="col-md-8 col-lg-6">
            <div className="construction-container p-4 text-center">
              <h1 className="mb-4">Support Us</h1>
              ...
              <div className="construction-notice mb-4">
                ...
                <p className="lead">
                  We're building ways for you to support our mission.
                </p>
                <p>
                  Thank you for your interest in supporting Lamp to my feet. 
                  We're working hard to set up various ways you can contribute. 
